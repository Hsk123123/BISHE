        ...
        >
          <div class="notice-header">
            <div class="notice-type">
              <van-tag :type="getTypeTag(notice.type)">
      ...
      <div class="notice-detail-popup" v-if="selectedNotice">
        <div class="detail-header">
          <div class="detail-type">
            <van-tag :type="getTypeTag(selectedNotice.type)">
...
type NoticeType = 'system' | 'activity' | 'rule' | 'update'
type NoticeTagType = 'primary' | 'success' | 'warning' | 'danger' | 'default'
...
const notices = ref<Notice[]>([
  {
    ...
    type: 'system',
    content:
      '亲爱的用户们，技能链平台正式上线啦！我们致力于为您提供最优质的个人服务对接平台。在这里，您可以轻松找到各种专业技能人才，也可以展示自己的特长获得额外收入。平台涵盖家政、维修、陪练、教学等多种服务类别，让您的生活更加便捷。',
    viewCount: 12580,
  ...
  },
  {
    ...
    type: 'activity',
    content:
      '即日起至1月31日，所有新用户首次下单立减20元，老用户推荐新用户下单可获得10元优惠券。\n\n活动规则：\n1. 新用户注册即享首单立减\n2. 推荐好友下单，双方各得10元优惠券\n3. 优惠券有效期为30天\n4. 本活动最终解释权归技能链平台所有',
    viewCount: 8560,
...
const getTypeTag = (type: NoticeType): NoticeTagType => {
  const tags: Record<NoticeType, NoticeTagType> = {
    system: 'primary',
    activity: 'success',
    rule: 'warning',
    update: 'primary'
...
const getTypeText = (type: NoticeType): string => {
  const texts: Record<NoticeType, string> = {
    system: '系统公告',
    activity: '活动公告',
    rule: '规则公告',
    update: '更新日志'
